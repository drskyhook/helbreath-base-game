...
const { store: itemDialogStore, toggle: toggleItemDialog, setOpen: setItemDialogOpen } = createDialogStore(initialState);

export { itemDialogStore, toggleItemDialog, setItemDialogOpen };
