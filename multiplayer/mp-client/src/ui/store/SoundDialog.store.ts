...
const { store: soundDialogStore, toggle: toggleSoundDialog, setOpen: setSoundDialogOpen } = createDialogStore(initialState);

export { soundDialogStore, toggleSoundDialog, setSoundDialogOpen };
