...
import { getMergedItems, ItemTypes, ItemEffect, type Effect, type Item } from '../../constants/Items';
...
function getItemsByCategory(): { category: ItemTypes; items: Item[] }[] {
    const byCategory = getMergedItems().reduce((acc, item) => {
