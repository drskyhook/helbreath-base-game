...
This guide describes how the camera system works in the mp-client. The system manages the main Phaser camera: follow target, zoom, bounds, UI-driven movement, and camera shake effects.
