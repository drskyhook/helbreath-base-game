...
| `requestPickUp()` | Left-click release on own cell | Plays pickup animation, sends `player_pickup_requested`, then sends the item-pickup completion request when the animation ends |
