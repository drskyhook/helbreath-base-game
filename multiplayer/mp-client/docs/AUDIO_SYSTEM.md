...
This guide describes how the audio system and spatial audio work in the mp-client. The system is built on Phaser 3's sound APIs and provides background music, sound effects, and positional (spatial) audio.
